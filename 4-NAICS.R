...
alpha1      <- mapply(function(x, y) naics_2eq_alpha(x, y, data = data, W = W),
                     x = NAICS.2008, y = NAICS.2010, SIMPLIFY = F)

beta1       <- mapply(function(x, y) naics_2eq_beta(x, y, data = data, W = W),
                     x = NAICS.2008, y = NAICS.2010, SIMPLIFY = F)
...
alpha2      <- mapply(function(x, y) naics_2eq_alpha(x, y, data = data, W = W),
                     x = NAICS.2008, y = NAICS.2010, SIMPLIFY = F)

beta2       <- mapply(function(x, y) naics_2eq_beta(x, y, data = data, W = W),
                     x = NAICS.2008, y = NAICS.2010, SIMPLIFY = F)
