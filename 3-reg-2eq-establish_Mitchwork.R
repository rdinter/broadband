...
source("2-data-set.R")
est  <- setvars(y1.1 = "Exmpt_Num.2010", y1.2 = "Exmpt_Num.2011",
                y1.l = "POPESTIMATE2009", y2.1 = "establishmentsA.2009",
                y2.2 = "establishmentsA.2011", y3.1 = "total_prov.2009B",
                y3.2 = NULL,
...
dir = "3-reg-2eq-establish_Mitchwork"
