...
wald2eq_new <- function(results, VAR){
...
names2eq_new <- function(results, k = 4){
  nA1  = "BB1"
  nA2  = "y2_l1"
  nWA2 = "Wy2_l1"
  nA2l = "y21"
...
wald3eq_new <- function(results, VAR){
  
  nA2   = "y2_l1" #employment t-1
  nWA2  = "Wy2_l1" #spatially lagged employment t-1
  nA2l  = "y21" #employment change
  nWA2l = "WY21" #spatially lagged employment change
  nA3   = "y3_l1" #broadband t-1
  nWA3  = "Wy3_l1" #spatially lagged broadband t-1
  nA3l  = "y31" #broadband change
  nWA3l = "WY31" #spatially lagged broadband change
  nLP   = "y1_l1" #population t-1
  nA    = c(nA2, nWA2, nA2l, nWA2l, nA3, nWA3, nA3l, nWA3l, nLP)
  
  nB2   = "y1_l2" #population t-1
  nWB2  = "Wy1_l2" #spatially lagged population t-1
  nB2l  = "y12" #population change
  nWB2l = "WY12" #spatially lagged population change
  nB3   = "y3_l2" #broadband t-1
  nWB3  = "Wy3_l2" #spatially lagged broadband t-1
  nB3l  = "y32" #broadband change
  nWB3l = "WY32" #spatially lagged broadband change
  nLE   = "y2_l2" #employment t-1
  nB    = c(nB2, nWB2, nB2l, nWB2l, nB3, nWB3, nB3l, nWB3l, nLE)
  
  nC2   = "y1_l3" #population t-1
  nWC2  = "Wy1_l3" #spatially lagged population t-1
  nC2l  = "y13" #population change
  nWC2l = "WY13" #spatially lagged population change
  nC3   = "y2_l3" #employment t-1
  nWC3  = "Wy2_l3" #spatially lagged employment t-1
  nC3l  = "y23" #employment change
  nWC3l = "WY23" #spatially lagged employment change
  nLB   = "y3_l3" #broadband t-1
  nC    = c(nC2, nWC2, nC2l, nWC2l, nC3, nWC3, nC3l, nWC3l, nLB)
...
names3eq_new <- function(results, k = 4){
  nA2   = "y2_l1" #employment t-1
  nWA2  = "Wy2_l1" #spatially lagged employment t-1
  nA2l  = "y21" #employment change
  nWA2l = "WY21" #spatially lagged employment change
...
se2eq_new <- function(results, VAR){
